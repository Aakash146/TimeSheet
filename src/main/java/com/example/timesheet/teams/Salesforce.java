...
public class Salesforce {
    ...
    public Salesforce(){
        ...
        List<String> abhishek = List.of(new String[]{"Abhishek Singh","Sunny Mohla","Tarun Rawal","Yong Liu","abhishek.singh10@nagarro.com","sunny.mohla@nagarro.com","tarun.rawal@nagarro.com","zhiyong.liu@coxautoinc.com","3161796"});
        ...
        List<String> karan = List.of(new String[]{"Karan Dhir","Sunny Mohla","Tarun Rawal","Yong Liu","karan.dhir01@nagarro.com","sunny.mohla@nagarro.com","tarun.rawal@nagarro.com","zhiyong.liu@coxautoinc.com","3211561"});
